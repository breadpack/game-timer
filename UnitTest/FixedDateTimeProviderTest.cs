...
public class FixedDateTimeProviderTest {
    ...
    public void Setup() {
        ...
        _dateTimeProvider = new FixedDateTimeProvider(new DateTime(2023, 4, 10, 0, 0, 0, DateTimeKind.Unspecified),
                                                      TimeZoneInfo.CreateCustomTimeZone("System", TimeSpan.FromHours(-8), "System", "System")); // Fixed date for consistent testing
    }
    ...
    public void TimerAtFixedDay_ShouldResetAtSpecifiedDay() {
        ...
        var expected = new DateTime(2023, 4, 15, 8, 0, 0, DateTimeKind.Utc);
    ...
    public void TimerAtFixedTimeInterval_ShouldResetAfterInterval() {
        ...
        var lastTime = TimeZoneInfo.ConvertTimeToUtc(_dateTimeProvider.Now.AddHours(-1), _dateTimeProvider.TimeZoneInfo); // Last reset was an hour ago
        var expected = TimeZoneInfo.ConvertTimeToUtc(_dateTimeProvider.Now.Date.AddDays(1), _dateTimeProvider.TimeZoneInfo);
    ...
    public void TimerAtFixedTime_ShouldResetNextDayIfPastInterval() {
        ...
        var lastTime = TimeZoneInfo.ConvertTimeToUtc(_dateTimeProvider.Now.AddHours(4), _dateTimeProvider.TimeZoneInfo); // 2023년 4월 10일 오전 4시
        var expected = TimeZoneInfo.ConvertTimeToUtc(_dateTimeProvider.Now.Date.AddDays(1).AddHours(3), _dateTimeProvider.TimeZoneInfo); // 2023년 4월 11일 오전 3시
    ...
    public void TimerAtFixedTimeOfWeek_Should() {
        ...
        var expected = TimeZoneInfo.ConvertTimeToUtc(_dateTimeProvider.Now.Date.AddDays(2).AddHours(3), _dateTimeProvider.TimeZoneInfo); // 2023년 4월 10일 화요일 오전 3시 
